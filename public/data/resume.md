...
- Server Actions, REST APIs, GraphQL
- PostgreSQL, MongoDB

### Tools & Technologies
- Git, GitHub, Vercel, VS Code
- Postman, Netlify, NPM, Webpack

### Other Skills
- Performance Optimization
- SEO, Progressive Web Apps (PWA)
- Accessibility (WCAG)
...
**Achievements:**
- Successfully delivered 5+ production applications
...
- **E-Commerce Solutions**: Custom e-commerce platforms with payment integration
- **Portfolio Websites**: Professional portfolio sites for developers and businesses

## Availability

Available for freelance work and full-time opportunities. Open to remote work and collaborations on exciting projects.
