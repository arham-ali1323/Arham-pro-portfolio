...
export const metadata: Metadata = {
  ...
  description: 'Explore the resume of Arham Ali, a Front-End Developer skilled in Next.js,  , and modern web technologies.',
  robots: 'index, follow',
  openGraph: {
    title: 'Arham Ali – Front-End Developer Resume',
    ...
    images: ['https://arhamali.me/arham-avater.png']
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Arham Ali – Front-End Developer Resume',
    description: 'Explore Arham Ali\'s resume and projects. Skilled in Next.js,  , and modern web technologies.',
    images: ['https://arhamali.me/arham-avater.png']
  },
  alternates: {
